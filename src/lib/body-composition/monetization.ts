...
export const BODY_COMPOSITION_AD_SLOTS: BodyCompositionAdSlot[] = [
  {
    ...
    sponsor: "Protein Lab",
    embedHtml:
      '<a class="coach-ad-link" href="https://example.com/protein-lab" target="_blank" rel="noreferrer"><strong>Protein Lab Whey</strong><span>운동 직후 단백질 24g 보충</span></a>',
    fallbackTitle: "Protein Lab Whey",
    fallbackCopy: "운동 직후 단백질 24g 보충",
  ...
  },
  {
    ...
    sponsor: "Fit Measure",
    embedHtml:
      '<a class="coach-ad-link" href="https://example.com/fit-measure" target="_blank" rel="noreferrer"><strong>주간 인바디 이용권</strong><span>체성분 리포트 측정권 묶음</span></a>',
    fallbackTitle: "주간 인바디 이용권",
    fallbackCopy: "체성분 리포트 측정권 묶음",
...
const FALLBACK_AD_SLOT: BodyCompositionAdSlot = {
  ...
  fallbackCopy: "보충제, 측정권, 운동 루틴 추천 슬롯이 이 자리에 표시됩니다.",
  href: "#",
};
...
export function buildAdRailViewModel({
  ...
  if (plan === "premium") {
    return {
      mode: "premium",
      title: "Premium 활성화",
      copy: "광고 없이 코치 해석과 비교 기능을 더 깔끔하게 볼 수 있습니다.",
    };
  }
